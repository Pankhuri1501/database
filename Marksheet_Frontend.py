...
def marksheet():
       ...
       Label_Father_Name = Label(Frame_1, text = 'Father Name', font = ('arial',15,'bold'), bg = 'grey')
       ...
       Label_Mother_Name = Label(Frame_1, text = 'Mother Name', font = ('arial',15,'bold'), bg = 'grey')
       ...
       Label_DOB = Label(Frame_1, text = 'Date of Birth', font = ('arial',15,'bold'), bg = 'grey')
       ...
       Label_Gender = Label(Frame_1, text = 'Gender', font = ('arial',15,'bold'), bg = 'grey')
       Label_Gender.grid(row = 2, column = 3, padx = 80)
       Entry_Gender = ttk.Combobox(Frame_1, state='readonly',values = (' ','Male','Female','Others'), font = ('arial',15), width = 23, textvariable = gender)
       Entry_Gender.grid(row = 2, column = 4, padx = 5, pady = 5)


       Label_School = Label(Frame_1, text = 'School Name', font = ('arial',15,'bold'), bg = 'grey')
       ...
       Label_Email = Label(Frame_1, text = 'Email ID', font = ('arial',15,'bold'), bg = 'grey')
       ...
       #========================================================Frame_2==================================================================       
       Frame_2 = LabelFrame(root, width = 1200, height = 400, font = ('arial',20,'bold'), bg = 'grey', bd = 10 \
       ...
       Label_Subject = Label(Frame_2, text = 'SUBJECT', font = ('arial',16,'bold'), bg = 'grey')
       Label_Subject.grid(row = 3, column = 0, padx = 50, pady = 10)

       Label_obt_Marks = Label(Frame_2, text = 'MARKS OBTAINED', font = ('arial',16,'bold'), bg = 'grey')
       Label_obt_Marks.grid(row = 3, column = 1, padx = 20)

       Label_Subject = Label(Frame_2, text = 'PASSING MARKS', font = ('arial',16,'bold'), bg = 'grey')
       Label_Subject.grid(row = 3, column = 2, padx = 20)

       Label_obt_Marks = Label(Frame_2, text = 'TOTAL MARKS', font = ('arial',16,'bold'), bg = 'grey')
       Label_obt_Marks.grid(row = 3, column = 3, padx = 20)

       Label_1 = Label(Frame_2, text = 'CS', font = ('arial',14), bg = 'grey')
       Label_1.grid(row = 4, column = 0)
       Label_2 = Label(Frame_2, text = 'PE', font = ('arial',14), bg = 'grey')
       Label_2.grid(row = 5, column = 0)
       Label_3 = Label(Frame_2, text = 'DC', font = ('arial',14), bg = 'grey')
       Label_3.grid(row = 6, column = 0)
       Label_4 = Label(Frame_2, text = 'SC', font = ('arial',14), bg = 'grey')
       Label_4.grid(row = 7, column = 0)
       Label_5 = Label(Frame_2, text = 'FOCS', font = ('arial',14), bg = 'grey')
       Label_5.grid(row = 8, column = 0)
       Label_6 = Label(Frame_2, text = 'GRAND TOTAL', font = ('arial',16), bg = 'grey')
       Label_6.grid(row = 9, column = 0)
       Label_7 = Label(Frame_2, text = 'PERCENTAGE', font = ('arial',16,'bold'), bg = 'grey')
       Label_7.grid(row = 10, column = 0)
       Label_8 = Label(Frame_2, text = 'CGPA', font = ('arial',16,'bold'), bg = 'grey')
       Label_8.grid(row = 10, column = 2)
       Label_9 = Label(Frame_2, text = 'GRADE', font = ('arial',16,'bold'), bg = 'grey')
       Label_9.grid(row = 10, column = 4)
       Label_10 = Label(Frame_2, text = 'DIVISION', font = ('arial',16,'bold'), bg = 'grey')
       Label_10.grid(row = 11, column = 0)
       Label_10 = Label(Frame_2, text = 'RESULT', font = ('arial',16,'bold'), bg = 'grey')
